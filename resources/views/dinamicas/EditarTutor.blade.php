    ...
    <div class="container posicionsregisalum">
        ...
        <form action="{{ route('EditarTutor') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ApellidoPaterno" id="ApellidoPaterno" value="{{ $Tutor->ApellidoPaterno }}"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Ciudad" id="Ciudad" class="form-control" value="{{ $Tutor->Ciudad }}"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ColFrac" id="ColFrac" class="form-control" value="{{ $Tutor->ColFrac }}"
                    required>
            </div>

            <div class="form-group">
                <label for="Calle">Calle:</label>
                <input type="text" name="Calle" id="Calle" class="form-control" value="{{ $Tutor->Calle }}"
                    required>
            </div>
