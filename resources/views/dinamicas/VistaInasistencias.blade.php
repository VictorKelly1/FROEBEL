                ...
                <thead class="bg-blue-700">
                    ...
                    <tbody>
                        @foreach ($Calificaciones as $Calificacion)
                            ...
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">{{ $Calificacion->Foto }}</td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">{{ $Calificacion->Fecha }}</td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">{{ $Calificacion->Motivo }}</td>
