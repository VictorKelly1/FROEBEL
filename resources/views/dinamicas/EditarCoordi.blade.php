...
<x-director.layout>
@if(!empty($Coordinador) && $Coordinador = null)
    <div class="container posicionsregisalum">

        <form action="{{ route('EditarCoordi') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ApellidoPaterno" id="ApellidoPaterno" value="{{ $Coordinador->ApellidoPaterno }}"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="CURP" id="CURP" class="form-control" value="{{ $Coordinador->CURP }}"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Ciudad" id="Ciudad" class="form-control" value="{{ $Coordinador->Ciudad }}"
                    required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ColFrac" id="ColFrac" class="form-control" value="{{ $Coordinador->ColFrac }}"
                    required>
            </div>

            <div class="form-group">
                <label for="Calle">Calle:</label>
                <input type="text" name="Calle" id="Calle" class="form-control" value="{{ $Coordinador->Calle }}"
                    required>
            </div>
