                    ...
                    <tbody>
                        @foreach ($Calificaciones as $Calificacion)
                            <tr class="hover:bg-gray-800 bg-transparent">
                                ...
                                <td>{{ $Calificacion->NombreGrado }} {{ $Calificacion->NivelAcademico }} {{ $Calificacion->Paquete }}</td>
                ...
                <table class="text-xs text-left text-white">
                    ...
                    <tfoot>
                        <tr class="bg-gray-700">
                            ...
                            <td class="font-bold">{{ number_format($promedioGeneral / $Calificaciones->count(), 2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
