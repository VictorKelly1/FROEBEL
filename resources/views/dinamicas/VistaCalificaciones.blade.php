                        ...
                        <tbody id="tableBody">
                            @foreach ($Calificaciones as $Calificacion)
                                <tr class="hover:bg-gray-800 bg-transparent">
                                    ...
                                    <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                        {{ $Calificacion->NombreGrado }} {{ $Calificacion->NivelAcademico }}
                ...
                <x-imprimir.print-table />
                    ...
                    <table id="miTabla" class="text-sm text-left text-white w-full table-auto z-30">
                        ...
                        <tbody id="tableBody">
                            ...
                            @foreach ($Calificaciones as $Calificacion)
                                ...
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                    {{ $Calificacion->NombreMateria }}</td>
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                    {{ number_format($trimestre1, 2) }}</td>
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                    {{ number_format($trimestre2, 2) }}</td>
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                    {{ number_format($trimestre3, 2) }}</td>
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                        ...
                        <tfoot>
                            <tr class="hover:bg-gray-800 bg-transparent">
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center"
                                    colspan="4">Promedio General de Trimestres:</td>
                                <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
