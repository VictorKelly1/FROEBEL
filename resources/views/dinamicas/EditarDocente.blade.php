<x-director.layout>
    ...
    <div class=" flex items-center  posiciontablas">
            ...
            <form class="formulario" action="{{ route('EditarDocente') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ColFrac" id="ColFrac" class="form-control"
                        value="{{ $Docente->ColFrac }}" required>
                </div>

                <div class="form-group">
                    <label for="Calle">Calle:</label>
                    <input type="text" name="Calle" id="Calle" class="form-control"
                        value="{{ $Docente->Calle }}" required>
                </div>
