            ...
            <form action="{{ route('EditarAdmin') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="Nombre" id="Nombre" class="form-control"
                        value="{{ $Administrador->Nombre }}" required>
                </div>

                <div class="form-group">
                    <label for="ApellidoPaterno">Apellido Paterno:</label>
                    <input type="text" name="ApellidoPaterno" id="ApellidoPaterno"
                        value="{{ $Administrador->ApellidoPaterno }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="CURP" id="CURP" class="form-control"
                        value="{{ $Administrador->CURP }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="Ciudad" id="Ciudad" class="form-control"
                        value="{{ $Administrador->Ciudad }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ColFrac" id="ColFrac" class="form-control"
                        value="{{ $Administrador->ColFrac }}" required>
                </div>

                <div class="form-group">
                    <label for="Calle">Calle:</label>
                    <input type="text" name="Calle" id="Calle" class="form-control"
                        value="{{ $Administrador->Calle }}" required>
                </div>
