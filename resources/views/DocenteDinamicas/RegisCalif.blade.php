                ...
                <table class="text-sm text-left text-white w-full table-auto z-30">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr class="hover:bg-gray-800 bg-transparent">
                            <!-- Materia -->
                            <td class="px-4 py-2 border-t border-blue-500 animate-border">{{ $Calificacion->NombreMateria }}</td>
                            
                            <!-- PARCIALES - Editables -->
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <input type="number" name="Parcial1[{{ $Calificacion->id }}]" value="{{ $Calificacion->Parcial1 }}" class="bg-transparent text-white border-none w-full text-center" min="0" max="10" step="0.1">
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <input type="number" name="Parcial2[{{ $Calificacion->id }}]" value="{{ $Calificacion->Parcial2 }}" class="bg-transparent text-white border-none w-full text-center" min="0" max="10" step="0.1">
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <input type="number" name="Parcial3[{{ $Calificacion->id }}]" value="{{ $Calificacion->Parcial3 }}" class="bg-transparent text-white border-none w-full text-center" min="0" max="10" step="0.1">
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <input type="number" name="Parcial4[{{ $Calificacion->id }}]" value="{{ $Calificacion->Parcial4 }}" class="bg-transparent text-white border-none w-full text-center" min="0" max="10" step="0.1">
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <input type="number" name="Parcial5[{{ $Calificacion->id }}]" value="{{ $Calificacion->Parcial5 }}" class="bg-transparent text-white border-none w-full text-center" min="0" max="10" step="0.1">
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <input type="number" name="Parcial6[{{ $Calificacion->id }}]" value="{{ $Calificacion->Parcial6 }}" class="bg-transparent text-white border-none w-full text-center" min="0" max="10" step="0.1">
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
