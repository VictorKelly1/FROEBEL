                ...
                <tbody>
                    @foreach ($Grupos as $Grupo)
                        <tr class="hover:bg-gray-800 bg-transparent">
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->ClavePeriodo }}
                            </td>
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->NombreGrado }}
                            </td>
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->Paquete }}</td>
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->NivelAcademico }}
                            </td>
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->FechaInicio }}
                            </td>
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->FechaFin }}</td>
                            <td class="px-2 py-1 border-t border-purple-500 animate-border">{{ $Grupo->TipoPeriodo }}
                            </td>
