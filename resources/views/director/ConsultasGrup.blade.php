        ...
        <div class="w-full max-w-full">
            ...
            <table class="text-sm text-left text-white w-full table-auto z-30">
                <thead class="bg-blue-700">
                    ...
                    <th class="px-4 py-2 text-lg border-b border-blue-500 animate-border text-center">Nivel Academico</th>
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                    <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">{{ $Grupo->ClavePeriodo }}
                            </td>
                    <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">{{ $Grupo->NombreGrado }}
                            </td>
                            <td class="px-6 py-4 border-t border-blue-500 animate-border text-center">{{ $Grupo->Paquete }}</td>
                            <td class="px-6 py-4 border-t border-blue-500 animate-border text-center">{{ $Grupo->NivelAcademico }}
                            </td>
                            <td class="px-6 py-4 border-t border-blue-500 animate-border text-center">{{ $Grupo->FechaInicio }}
                            </td>
                            <td class="px-6 py-4 border-t border-blue-500 animate-border text-center">{{ $Grupo->FechaFin }}</td>
                            <td class="px-6 py-4 border-t border-blue-500 animate-border text-center">{{ $Grupo->TipoPeriodo }}
                            </td>
