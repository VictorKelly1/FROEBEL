                        ...
                        <tr class="hover:bg-gray-800 bg-transparent">
                            ...
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <form action="/CalificacionAlumno/{{ $alumno->idAlumno }}" method="GET">
                                    <button
                                        class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-blue-600">Calificaciones</button>
                                </form>
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <form action="/VistaRegistrarColegiatura/{{ $alumno->idAlumno }}" method="GET">
                                    <button
                                        class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-blue-600">Pagar</button>
                                </form>
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <form action="/InasistenciasParticularesD/{{ $alumno->idAlumno }}" method="GET">
                                    <button
                            ...
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <form action="/VistaComunicadoPersonal/{{ $alumno->idAlumno }}" method="GET">
                                    <button
                                        class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Comunicado</button>
                                </form>
                            </td>
                            <td class="px-4 py-2 border-t border-blue-500 animate-border text-center">
                                <form action="/VistaEditarAlumno/{{ $alumno->idAlumno }}" method="GET">
                                    <button
                                        class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-600">Editar</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
