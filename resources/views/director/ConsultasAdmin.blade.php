                ...
                <tbody id="tableBody">
                    @foreach ($Administradores as $Administrador)
                        <tr class="hover:bg-gray-800 bg-transparent">
                            <td class="px-4 py-2 border-t border-purple-500 animate-border">{{ $Administrador->Nombre }}
                            </td>
                            ...
                            <td class="px-4 py-2 border-t border-purple-500 animate-border">{{ $Administrador->CURP }}
                            </td>
                            <td class="px-4 py-2 border-t border-purple-500 animate-border">
