...
<div class=" flex items-center justify-center bg-gray-900 p-2 posiciontablas borderAnimation overflow-x-hidden z-20">
        <div class="overflow-x-auto w-full max-w-full z-20">
            ...
            <th class="px-4 py-2 text-lg border-b border-purple-500 animate-border text-center">FechaIngreso</th>
            ...
            <tbody id="tableBody">
                ...
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Nombre }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->ApellidoPaterno }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->ApellidoMaterno }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->CURP }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->FechaNacimiento }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Genero }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Ciudad }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Municipio }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->CodigoPostal }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->ColFrac }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Calle }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->NumeroExterior }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->EstadoCivil }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Nacionalidad }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Foto }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Carrera }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->FechaIngreso }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Estado }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->RFC }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->NoINE }}</td>
                <td class="px-6 py-4 border-t border-purple-500 animate-border text-center">{{ $Docente->Sueldo }}</td>
