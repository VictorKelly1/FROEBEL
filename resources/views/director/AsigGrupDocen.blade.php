<x-director.layout>
    ...
    <div class="relative mb-4">
        <div class="absolute top-0 right-0 p-2">
            <input type="search" id="searchInput" placeholder="Buscar Docente..." 
    ...
    <div class="posiciontablasmedia flex items-center justify-center bg-gray-900 p-6 mt-6 rounded-md border border-blue-500 shadow-md w-3/4 sm:w-2/3 lg:w-1/2">
        <form class="w-full text-white text-base" action="{{ route('AsignarGrupDocente') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <!-- 👩‍🏫 Docente -->
            <div class="mb-4">
                <label for="Docente" class="block mb-2 text-lg">Docente:</label>
                <select name="idDocente" id="Docente" class="w-full px-4 py-2 rounded-md bg-gray-800 border border-blue-500 text-white text-lg" required>
