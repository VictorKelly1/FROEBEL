<x-director.layout>
    ...
    <div
        class="posiciontablahorario flex items-center justify-center bg-gray-900 p-1 mt-2 rounded-md border border-blue-500 shadow-md w-full sm:w-3/4 lg:w-2/3 overflow-x-auto z-30">
        <div class="w-full">
                ...
                <tbody id="tableBody">
                    @foreach ($Materias as $Materia)
                        <tr class="hover:bg-gray-800 text-center">
                            ...
                            <td class="px-1 py-1 border-t border-purple-500">{{ $Materia->NombreMateria }}</td>
