<div class="">
    <!-- Sidebar -->
    <div id="sidebar" class="led led2 posicionsidebar w-64 bg-gray-900 text-white flex flex-col transition-all duration-300 ease-in-out
        ...
        <ul class="flex-1 space-y-2 p-4 ">
            ...
            <li class="flex items-center gap-4 hover:bg-gray-800 rounded-lg p-3 transition-all duration-200">
                <img src="{{ asset('images/transacciones.png') }}" alt="Transacciones" class="icon w-6 h-6 transition-all duration-300">
           ...
           <li class="group flex flex-col items-start gap-2 hover:bg-gray-800 rounded-lg p-3 transition-all duration-200 relative">
    <!-- Elemento principal -->
    ...
    <!-- Submenú -->
    <ul class="hidden group-hover:block bg-gray-700 text-white rounded-lg mt-2 ml-8 p-2 w-48 shadow-lg transition-all duration-300">
        <li class="hover:bg-gray-600 rounded p-2">
            <a href="{{ route('ListaGruposAlum') }}" class="flex items-center gap-2">
